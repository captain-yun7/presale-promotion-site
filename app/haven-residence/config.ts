...
const config: ProjectConfig = {
  ...
  location: {
    ...
    address: "서울시 영등포구 신길동 449-11",
    coords: { lat: 37.5080, lng: 126.9187 },
    details: [
  ...
  gallery: {
    ...
    items: [
      ...
      { category: "interior", label: "실내 사진 03", caption: "실내 공간 — 고급 마감재 적용", image: "/images/haven-residence/gallery/interior-03.png" },
      { category: "interior", label: "실내 사진 04", caption: "실내 공간 — 넓은 개방감 설계", image: "/images/haven-residence/gallery/interior-04.png" },
      { category: "interior", label: "실내 사진 05", caption: "실내 공간 — 세련된 인테리어", image: "/images/haven-residence/gallery/interior-05.png" },
